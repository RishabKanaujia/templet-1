...
const ProductPop = ({ proData,closePop }) => {
  return (
    <div className="w-[100%] max-w-[1000px] flex fixed justify-center z-30 items-center top-0 h-[100vh] bg-[#05050577]">
      <div className="flex gap-7 justify-center items-center flex-col bg-white max-w-[720px] w-full h-[90%] rounded-[30px]">
        ...
        <img className="w-[400px] rounded-[30px]" src={proData.src} alt="" />
